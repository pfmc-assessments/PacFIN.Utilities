...
#' 
plotStrat <- function(data, dir, ylimperc = 0.65, npages = 11) {
...
g <- ggplot(data = plotmea,
 aes(x = time, y = F, linetype = wo, 
  col = interaction(state, fleet, sep = "-", lex.order = TRUE))) + 
geom_line(lwd = 0.7) + 
